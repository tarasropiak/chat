...
${OBJECTDIR}/_ext/1360937237/Logger.o: ../src/Logger.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/Logger.o ../src/Logger.cpp

${OBJECTDIR}/_ext/1360937237/LoggerImplAndroid.o: ../src/LoggerImplAndroid.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -g -I../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/LoggerImplAndroid.o ../src/LoggerImplAndroid.cpp

${OBJECTDIR}/_ext/1360937237/LoggerImplPosix.o: ../src/LoggerImplPosix.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -g -I../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/LoggerImplPosix.o ../src/LoggerImplPosix.cpp

...
${OBJECTDIR}/_ext/1360937237/Session.o: ../src/Session.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG=1 -DENABLE_SOFIA_SIP_LOGGING=1 -I../../logger/include -I../include -I/usr/include/sofia-sip-1.12 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/Session.o ../src/Session.cpp

${OBJECTDIR}/_ext/1360937237/SIPClient.o: ../src/SIPClient.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG=1 -DENABLE_SOFIA_SIP_LOGGING=1 -I../../logger/include -I../include -I/usr/include/sofia-sip-1.12 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/SIPClient.o ../src/SIPClient.cpp

${OBJECTDIR}/_ext/1360937237/SIPLogging.o: ../src/SIPLogging.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG=1 -DENABLE_SOFIA_SIP_LOGGING=1 -I../../logger/include -I../include -I/usr/include/sofia-sip-1.12 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/SIPLogging.o ../src/SIPLogging.cpp

${OBJECTDIR}/_ext/1360937237/SIPTaskBase.o: ../src/SIPTaskBase.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG=1 -DENABLE_SOFIA_SIP_LOGGING=1 -I../../logger/include -I../include -I/usr/include/sofia-sip-1.12 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/SIPTaskBase.o ../src/SIPTaskBase.cpp
